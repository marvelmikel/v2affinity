    ...
    <section class="w-full py-16">
        <div class="mx-auto px-8 sm:px-16 lg:px-4 2xl:max-w-screen-2xl xl:max-w-screen-xl">
            ...
            <x-home-faq-section id="faq_section">
                ...
                @livewire('faq',['faq_id'=>'faq4','question'=>'How much does it cost?','answer'=>'The system costs £150 plus VAT per store. No hidden costs and you can have up to 3 users per store. We can add further users upon request.'])
