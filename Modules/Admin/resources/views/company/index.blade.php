        ...
        <div class="" style="max-height: 500px; overflow-y: auto;">
            ...
            <table class="table " style="margin: 40px 0;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="width:0.1%;"><input disabled readonly class="form-control" type="text" name="name" value="1"></td>

                        <td style="width:10%;"><input readonly class="form-control" type="text" name="role_name" value="bedroom"></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-data"></i> Add New Room Location</h4>
                </div>
                <form action="" method="post">
                    @csrf()
