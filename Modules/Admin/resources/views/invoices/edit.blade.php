                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control select" value="{{ old('store_id') }}" name="store_id"
                                        id="">
                                        ...
                                        @else
                                            ...
                                            @if (Auth::user()->store)
                                                <option value="{{ Auth::user()->store->id }}"
                                                    @if (old('store_id') == Auth::user()->store->id) selected @endif>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" type="text"
                                        value="{{ $invoice->customer->phone }}" name="customer_phone_number"
                                        id="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" type="text"
                                        value="{{ $invoice->customer->address_city }}" name="customer_address_city"
                                        id="">
                                </div>
                                    ...
                                    <tr style="overflow: scroll;">
                                            ...
                                            @if ($meta->name != 'formular')
                                                @if ($meta->type == 'formular')
                                                    <td style="min-width: 200px;" class="{{ $meta->visibility }}">
                                                        <input disabled readonly
                                                            class="form-control  {{ $meta->visibility }} " type="text"
                                                            name="{{ $meta->name }}[]" value="{{ $meta->name }}">
                                                        <input disabled readonly style="background-color: white;"
                                                            class="form-control evaluated-input  {{ $meta->visibility }}"
                                                            name="{{ $meta->name }}[]"
                                                            value="{{ evaluate_formular($meta->value, 'InvoiceItemMeta', $invoiceItem->id, $meta->modifier) }}"
                                                            type="{{ $meta->type }}" {{ $meta->visibility }}>

                                                        <input disabled readonly style="background-color: white;"
                                                            class="form-control  {{ $meta->visibility }}" type="hidden"
                                                            name="{{ $meta->name }}[]"
                                                ...
                                                @else
                                                    <td style="min-width: 200px;" class="{{ $meta->visibility }}">
                                                        <input disabled readonly
                                                            class="form-control  {{ $meta->visibility }}" type="text"
                                                            name="{{ $meta->name }}[]" value="{{ $meta->title }}">
                                        ...
                                        <td style="min-width: 200px;">
                                            ...
                                            <input readonly style="background-color: white;" class="form-control"
                                                type="text" value="{{ number_format($invoiceItem->item_total, 2) }}">
                                        </td>

                                        <td>
                                            <button type="submit" class="btn btn-success"><i
                                                    class="voyager-book"></i></button>
                                        <td colspanss="3">
                                            <a href="{{ route('voyager.invoices.delete-item', [$invoice->id, $invoiceItem->id]) }}"
                                                style="text-decoration: none;" data-invoiceid=""
                                                class="btn btn-sm btn-danger"><i class="voyager-trash"></i></a>
                                            <a href="#" data-invoiceitemid="{{ $invoiceItem->id }}"
                                                class="btn btn-secondary btn-xs add-column-btn"><i
                                                    class="voyager-plus"></i>Add Column</a>
                                        </td>
                                        </td>
                                        <td>
                                    </tr>
                        ...
                        <tbody>
                            <form action="{{ route('voyager.invoices.save-pricing', [$invoice->id]) }} ">
                                    ...
                                    @if ($pricing->name != 'formular')
                                        @if ($pricing->name == 'tax' || $pricing->name == 'discount')
                                            <tr>
                                                ...
                                                <td>
                                                    <input readonly style="background-color: white;" class="form-control"
                                                        type="text" name="{{ $pricing->name }}[]"
                                                        value="{{ $pricing->identifier }}">
                                                </td>
                                            </tr>
                                        @else
                                            <tr>
                                ...
                                @if (Auth::check() && Auth::user()->role_id == 1)
                                    <tr>
                                        <td><input disabled readonly class="form-control" type="text"
                                                name="formular[]" value="formular"></td>
                                        ...
                                        <td><input readonly style="background-color: white;" class="form-control"
                                                type="text" name="formular[]"
                                                value="{{ $invoice->getPricing('formular')['identifier'] }}">
                                        </td>
                                    </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input readonly style="background-color: white;"
                                            class="form-control" type="text"
                                            value="{{ number_format($invoice->total, 2) }}"></td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a style="text-decoration: none;" target="_blank" href=""
                                            class="btn btn-primary"><i class="voyager"></i>Email Invoice</a>
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('voyager.invoices.add-meta-column', $invoice->id) }}" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit"
                                class="btn btn-primary pull-right" ">{{ __('voyager::generic.save') }}</button>
                                </div>
                            </form>
                        </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
