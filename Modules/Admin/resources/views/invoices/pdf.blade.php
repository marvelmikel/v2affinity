...
<div class="top_section">
    <div class="logo_section">
        ...
        <p style="text-transform:uppercase;margin:0;color:#415280;font-weight:bold;">Store: LogicBarn</p>
...
{{--
    <div class="totals_price">
        ...
        <div class="price_row">
            <div class="price_row_title">
                <span>Outstanding Balance &pound;:</span>
            </div>
            <div class="price_row_box" style="border:1px solid #000">
                <span>£300.00</span>
            </div>
        </div>
    </div>
--}}
    <!-- <div class="totals_payment">
        <p>
            AFRAF: <span class="payment_box" style="margin-right: 320px"><span style="padding-right: 3px">X</span></span>
            Payment Method:
            Cash/Cheque: <span class="payment_box"><span style="padding-right: 3px">X</span></span>
            Card: <span class="payment_box"></span>
            Finance: <span class="payment_box"></span>
        </p>
    </div> -->
</div>

<!-- <div class="checklist">
    <span class="checkbox underlay yes">X</span>
    <span class="checkbox grippers no">X</span>
    <span class="checkbox doorplates yes">X</span>
    <span class="checkbox doorplatestypebrass">X</span>

    {{-- Show customer signature if checked --}}
    <span class="checkbox" style="font-family: 'Times-Roman', sans-serif; font-style: italic; font-size: 25px; position: absolute; left: 10px; bottom: 7px; width: 49%">{{ $customer->name }}</span>

    <img style="position:relative;width:100%;height:auto;opacity:1;z-index:1;" src="images/united_carpets/pdf_middle.png">

</div> -->

<!-- <div class="fitting">
    <div class="fitting_details">
        <div class="fitting_row_title">
            <span>Fitters notes:</span>
        </div>
    </div>
    <div class="fitting_price">
        <div class="price_row">
            <div class="price_row_title">
                <span>Fitting Estimate &pound;:</span>
            </div>
            <div class="price_row_box">
                <span>N/A</span>
            </div>
...
<footer class="footer" style="page-break-after:always;">
    <div class="store_details">
        ...
        <p>
            Company Registration No. 404 3017
            <span style="margin-left:10px;">VAT Registration No. 766 9136 87</span>
        </p>
    </div>
    <div class="copy">
        <p>CUSTOMER</p>
...
<div class="top_section">
    <img src="images/united_carpets/pdf_terms_2023_09_06.jpg" style="width:100%">
</div>
