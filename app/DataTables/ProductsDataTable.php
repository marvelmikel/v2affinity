...
class ProductsDataTable extends DataTable
{
    ...
    public function dataTable($query): EloquentDataTable
    {
        ...
        //checking if Auth user has permission to edit or delete
                $btn = '';
                if (auth()->user()->can('edit', $row) && auth()->user()->can('delete', $row)) {
                    ...
                    $btn = '<a href="'.$editUrl.'" class="btn btn-success btn-xs"><i class="voyager-edit"></i></a>';
                ...
                return $btn;
                // end checking if Auth user has permission to edit or delete
            })
            ->rawColumns(['action'])
            ->setRowId('id');
    }
